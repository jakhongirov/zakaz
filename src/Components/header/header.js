		...
		<>
				...
				<div className="container">
					<div className="header__top">
						<div class="phone">
							<a
								class="phone__number number_one"
								href="tel:+998712415470"
							>
								+99871 241-54-70
							</a>
							<a class="phone__number" href="tel:+998712415470">
								+99871 241-54-70
							</a>
						</div>
						...
						<div className="lang__box">
							<ul className="lang__list">
								<li
									className={checkLang =='uz' ? 'lang__item lang__item--active' : 'lang__item'}
									onClick={() => {
										dispatch({ type: 'uz' })
										setCheckLang('uz')
									}}
								...
								<li
									className={checkLang =='ru' ? 'lang__item lang__item--active' : 'lang__item'}
									onClick={() => {
										dispatch({ type: 'ru' })
										setCheckLang('ru')
									}}
								...
								<li
									className={checkLang =='en' ? 'lang__item lang__item--active' : 'lang__item'}
									onClick={() => {
										dispatch({ type: 'en' })
										setCheckLang('en')
									}}
